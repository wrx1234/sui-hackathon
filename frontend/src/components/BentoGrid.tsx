...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "transform-gpu bg-[#111] [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      className
    )}
  >
    <div>{background}</div>
    ...
    >
      <a
        ...
        className="pointer-events-auto inline-flex items-center gap-2 text-sm text-neutral-300 hover:text-white transition-colors"
      >
        {cta}
